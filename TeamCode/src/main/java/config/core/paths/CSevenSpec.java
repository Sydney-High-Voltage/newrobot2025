...
public class CSevenSpec {
    ...
    public static Pose deposit2 = new Pose(23,25.75, Math.toRadians(0));
    ...
    public static Pose grab3 = new Pose(9.25, 36, Math.toRadians(180));
    public static Pose score3 = new Pose(39, 66, Math.toRadians(180));
    public static Pose grab4 = new Pose(9.25, 37.5, Math.toRadians(180));
    public static Pose score4 = new Pose(39, 66, Math.toRadians(180));
    public static Pose grab5 = new Pose(9.25, 37.5, Math.toRadians(180));
    public static Pose score5 = new Pose(39, 66, Math.toRadians(180));
    public static Pose grab6 = new Pose(9.25, 37.5, Math.toRadians(180));
    public static Pose score6 = new Pose(39, 66, Math.toRadians(180));
    public static Pose grab7 = new Pose(9.25, 37.5, Math.toRadians(180));
    ...
    public static PathChain deposit2() {
        return new PathBuilder()
                ...
                .addPath(new BezierCurve(sub2, new Pose(sub2.getX() - 9.5, sub2.getY() + 9.5), deposit2))
    ...
    public static PathChain score2() {
        return new PathBuilder()
                .addPath(
                        new BezierCurve(
                                new Point(grab2),
                                new Point(grab2.getX() - 9.5, grab2.getY()),
                                new Point(score2)
                        )
                )
                .setNoDeceleration()
    ...
    public static PathChain deposit3() {
        return new PathBuilder()
                .addPath(new BezierCurve(
                        sub3,
                        new Pose(sub3.getX() - 15, sub3.getY() + 9.5),
                        deposit3
                ))
    ...
    public static PathChain deposit3() {
        return new PathBuilder()
                .setGlobalDeceleration()
                .addPath(new BezierCurve(sub3, new Pose(sub3.getX() - 9.5, sub3.getY() + 9.5), deposit3Drag))
        ...
        return new PathBuilder()
                ...
                .addPath(
                        ...
                        new BezierLine(
                                ...
                                new Point(34.500, 47.00, Point.CARTESIAN)
                        )
                )
    ...
    public static PathChain push1() {
        return new PathBuilder()
                ...
                .addPath(
                        ...
                        new BezierLine(
                                new Point(34.500, 47.00, Point.CARTESIAN),
                                new Point(27.500, 45.5, Point.CARTESIAN)
                        )
                )
    ...
    public static PathChain push2() {
        return new PathBuilder()
                ...
                .addPath(
                        ...
                        new BezierLine(
                                new Point(27.500, 45.5, Point.CARTESIAN),
                                new Point(34.000, 36.75, Point.CARTESIAN)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(245), Math.toRadians(305))
                .setZeroPowerAccelerationMultiplier(8)
                .build();
    }
    ...
    public static PathChain push3() {
        return new PathBuilder()
                ...
                .addPath(
                        ...
                        new BezierLine(
                                new Point(34.000, 36.75, Point.CARTESIAN),
                                new Point(27.500, 34.5, Point.CARTESIAN)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(305), Math.toRadians(235))
                .setZeroPowerAccelerationMultiplier(8)
                .build();
    }
    ...
    public static PathChain push4() {
        return new PathBuilder()
                ...
                .addPath(
                        ...
                        new BezierLine(
                                new Point(27.500, 34.5, Point.CARTESIAN),
                                new Point(36.000, 24.5, Point.CARTESIAN)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(235), Math.toRadians(315))
                .setZeroPowerAccelerationMultiplier(8)
                .build();
    }
        ...
        return new PathBuilder()
                ...
                .addPath(
                        new BezierCurve(
                                ...
                                new Point(grab3Drag.getX() + 9.5, grab3Drag.getY()),
                                new Point(grab3Drag)
                        )
                )
    ...
    public static PathChain score3() {
        return new PathBuilder()
                ...
                .addPath(
                        new BezierCurve(
                                grab3Drag,
                                new Pose(score3.getX() - 9.5, score3.getY()),
                                score3
                        )
                )
                .setNoDeceleration()
    ...
    public static PathChain grab3() {
        return new PathBuilder()
                .addPath(
                        new BezierCurve(
                                new Point(20, 9.5, Point.CARTESIAN),
                                new Point(grab3.getX() + 9.5, grab3.getY()),
                                new Point(grab3)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(250), Math.toRadians(180))
    ...
    public static PathChain score4() {
        return new PathBuilder()
                .addPath(
                        new BezierCurve(
                                grab4,
                                new Pose(score4.getX() - 9.5, score4.getY()),
                                score4
                        )
                )
                .setNoDeceleration()
    ...
    public static PathChain score5() {
        return new PathBuilder()
                .addPath(
                        new BezierCurve(
                                grab5,
                                new Pose(score5.getX() - 9.5, score5.getY()),
                                score5
                        )
                )
                .setNoDeceleration()
    ...
    public static PathChain score6() {
        return new PathBuilder()
                .addPath(
                        new BezierCurve(
                                grab6,
                                new Pose(score6.getX() - 9.5, score6.getY()),
                                score6
                        )
                )
                .setNoDeceleration()
    ...
    public static PathChain score7() {
        return new PathBuilder()
                .addPath(
                        new BezierCurve(
                                grab7,
                                new Pose(score7.getX() - 9.5, score7.getY()),
                                score7
                        )
                )
                .setNoDeceleration()
