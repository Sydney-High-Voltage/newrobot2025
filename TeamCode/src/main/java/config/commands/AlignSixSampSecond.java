...
public class AlignSixSampSecond extends CommandBase {
    ...
    public AlignSixSampSecond(Robot robot, ManualPose manualPose) {
        this.robot = robot;
    ...
    public void execute() {
        ...
        switch (state) {
            case 1:
                ...
                SixSamp.sub3 = manualPose.getPose().copy();
                robot.getF().followPath(SixSamp.sub3());
                setState(2);
                break;
            case 2:
